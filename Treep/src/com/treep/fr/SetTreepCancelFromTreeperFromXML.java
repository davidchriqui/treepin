...
public class SetTreepCancelFromTreeperFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetTreepCancelFromTreeperFromXML(Activity activity, String treepId, String driverId){
		this.activity=activity;
		this.treepId=treepId;
		this.driverId=driverId;
	}
	
	public SetTreepCancelFromTreeperFromXML(Activity activity, String treepId){
		this.activity=activity;
		this.treepId=treepId;
	}
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETTREEPCANCELFROMTREEPER);
		if(xml == null){
			mapErrCode = null;
		}
		else{
