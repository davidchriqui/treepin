...
public class SetTreepRatingFromTreeperFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetTreepRatingFromTreeperFromXML(Activity activity, String treepId, float rating){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETTREEPRATINGFROMTREEPER + "?userid=" + LoginDisplayActivity.userId + "&treepid=" + treepId + "&rating=" + rating);
