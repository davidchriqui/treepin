...
public class SetTreepCanceledFromDriverFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetTreepCanceledFromDriverFromXML(Activity activity, String treepId){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETTREEPCANCELEDFROMDRIVER + "?userid=" + LoginDisplayActivity.userId + "&treepid=" + treepId);
		if(xml == null){
			mapErrCode = null;
		}
		else{
