...
public class TreepDriverResponseAdapter extends BaseAdapter {

	private TreepDriverResponseListFragment activity;
	...
	public TreepDriverResponseAdapter(TreepDriverResponseListFragment a, ArrayList<HashMap<String, String>> d) {
		activity = a;
		data = d;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		View vi = convertView;
		if (convertView == null){
			vi = inflater.inflate(R.layout.list_row_treepdriverresponse, null);
		}
