...
public class SetTreepFinishedFromDriverFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetTreepFinishedFromDriverFromXML(Activity activity, String treepId, String treeperId){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETTREEPFINISHEDFROMDRIVER + "?userid=" + LoginDisplayActivity.userId + "&treepid=" + treepId);
	...
	protected void onPostExecute(HashMap<String, String>  result) {
		...
		if(result == null || result.containsKey(MainActivity.KEY_TIMEOUT)){
			...
			if(result.get(MainActivity.KEY_ERRCODE).equals("000")){
		        ...
		        try {
                    object.put("alert", LoginDisplayActivity.userFirstname + " " + LoginDisplayActivity.userLastname.charAt(0) + ". indique que le treep est terminé. Veuillez confirmer.");
                    object.put("title", "Treep : treep terminé");
