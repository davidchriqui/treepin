...
public class SetTreeperOnBoardFromTreeperFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetTreeperOnBoardFromTreeperFromXML(Activity activity, String treepId, String driverId){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETTREEPERONBOARDFROMTREEPER + "?userid=" + LoginDisplayActivity.userId + "&treepid=" + treepId);
	...
	protected void onPostExecute(HashMap<String, String>  result) {
		...
		if(result == null || result.containsKey(MainActivity.KEY_TIMEOUT)){
			...
			if(result.get(MainActivity.KEY_ERRCODE).equals("000")){
		        ...
		        try {
                    object.put("alert", LoginDisplayActivity.userFirstname + " " + LoginDisplayActivity.userLastname.charAt(0) + ". est à bord de votre voiture. Bonne route.");
                    object.put("title", "Treep : treeper à bord de votre voiture");
