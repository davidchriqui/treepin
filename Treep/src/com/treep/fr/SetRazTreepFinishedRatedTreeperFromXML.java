...
public class SetRazTreepFinishedRatedTreeperFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetRazTreepFinishedRatedTreeperFromXML(Activity activity, String treepId){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETRAZTREEPFINISHEDRATEDFORTREEPER + "?userid=" + LoginDisplayActivity.userId + "&treepid=" + treepId);
