...
public class SetTreepRatingFromDriverFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetTreepRatingFromDriverFromXML(Activity activity, String treepId, float rating){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETTREEPRATINGFROMDRIVER + "?userid=" + LoginDisplayActivity.userId + "&treepid=" + treepId + "&rating=" + rating);
