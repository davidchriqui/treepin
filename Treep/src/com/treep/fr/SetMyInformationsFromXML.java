...
public class SetMyInformationsFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetMyInformationsFromXML(Activity activity, String phoneNumber,String eMail, Boolean isMale ){
	...
	protected void onPreExecute() {
		...
		nameValuePairs.add(new BasicNameValuePair("usermail", eMail));
		nameValuePairs.add(new BasicNameValuePair("usersexe", isMale.toString()));
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETMYINFORMATIONS);
