...
public class SetDriverTreepNowResponseAckFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	
	private HashMap<String,String> mapErrCode = new HashMap<String,String>();
	private Activity activity;
	
	public SetDriverTreepNowResponseAckFromXML(Activity activity){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETDRIVERTREEPNOWRESPONSEACK + "?userid=" +LoginDisplayActivity.userId);
