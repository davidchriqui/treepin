...
public class SetMyProfileNewMailFromXML extends AsyncTask<Void, Integer, HashMap<String, String>> {
	...
	public SetMyProfileNewMailFromXML(Activity activity, String userMail){
	...
	protected HashMap<String, String> doInBackground(Void... arg0) {
		...
		String xml = parser.getXmlFromUrl(MainActivity.URL_SETMYPROFILEMAIL);
